export default function WeddingEntourage(){
    return(
        <div className="py-8 text-white flex flex-col h-full relative">
            <div className="h-full w-full bg-center bg-cover absolute top-0 left-0" style={{backgroundImage: "linear-gradient(to top, #34170DA2, #6E3C19AE), url(/assets/images/aesthetic/candles.jpg)"}}></div>
            <div className="relative z-10">
                <div className="px-8">
                    <p className="text-script text-3xl border-b border-white/50 pb-2">The Entourage</p>
                </div>
                <div className="h-[60px] w-full bg-center bg-cover relative mt-2" style={{backgroundImage: "linear-gradient(to left, #34170DA2, #6E3C19AE), url(/assets/images/aesthetic/wine.jpg)"}}></div>
                <div className="mt-4">
